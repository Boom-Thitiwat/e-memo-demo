...
// ── Reset Password ─────────────────────────────────────────────────────────────
// เรียก /api/send-reset-email → Firebase ส่ง link + SMTP ตัวอย่างส่งซ้ำ
...
export default function Login({ onDemoLogin }) {
  ...
  return (
    <div style={S.container}>
      <div style={S.card}>
        <div style={{...S.logoFallback, display:"flex"}}>
        ...
        {resetSent && (
          <div style={S.success}>
            ...
            <span style={{fontSize:12}}>ส่งจาก <strong>sender@example.com</strong></span><br/>
        ...
        {resetMode && !resetSent && (
          <p style={S.hint}>
            กรอก Email แล้วกด "ส่งลิงก์" — ระบบส่งจาก <strong>sender@example.com</strong>
          </p>
        )}
      </div>
    </div>
